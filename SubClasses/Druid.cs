...

{
    ...
    public Druid(int strength, int dexterity, int intelligence, int wisdom, int constitution, int charisma, Race race, int partyIndex)
    {
       this.Name = "Druid";
            this.IsAlive = true;
            ...
            this.Spells = new List<string> {"Healing Word","Entangle","Shillelagh"};
